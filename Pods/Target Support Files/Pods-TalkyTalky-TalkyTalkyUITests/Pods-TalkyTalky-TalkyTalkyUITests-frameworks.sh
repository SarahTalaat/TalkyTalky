...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseAppDistribution/FirebaseAppDistribution.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseDynamicLinks/FirebaseDynamicLinks.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseMLModelDownloader/FirebaseMLModelDownloader.framework"
